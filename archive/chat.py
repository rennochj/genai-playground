...
class ChatMessage(BaseModel):
    ...
    tool_call_id: Optional[str] = Field(None, description="Tool call ID if this is a response from a tool")
    function_call: Optional[Dict[str, Any]] = Field(None, description="The function call generated by the model")
...
class ChatResponse(BaseModel):
    ...
    system_fingerprint: Optional[str] = Field(None, description="Unique identifier for the model version")
